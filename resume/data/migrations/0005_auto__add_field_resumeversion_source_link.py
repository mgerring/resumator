...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumeVersion.source_link'
        db.add_column('data_resumeversion', 'source_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ResumeVersion.source_link'
        db.delete_column('data_resumeversion', 'source_link')
