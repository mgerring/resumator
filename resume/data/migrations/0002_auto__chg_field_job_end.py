...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.end'
        db.alter_column('data_job', 'end', self.gf('django.db.models.fields.DateField')(null=True))
    def backwards(self, orm):

        # Changing field 'Job.end'
        db.alter_column('data_job', 'end', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 5, 26, 0, 0)))
    models = {
        'auth.group': {
